...
public class ListHelper extends SQLiteOpenHelper {
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.insert(Structure_BBDD.TABLE4, null, values1);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values2);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values3);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values4);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values5);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values6);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values7);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values8);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values9);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values10);
        ...
        db.insert(Structure_BBDD.TABLE4, null, values11);

        ContentValues values12 = new ContentValues();
        values12.put(Structure_BBDD.COLUMNE2, "Bone meal");
        values12.put(Structure_BBDD.COLUMNE3, "3.5");
        values12.put(Structure_BBDD.COLUMNE4, "22");
        values12.put(Structure_BBDD.COLUMNE5, "");
        db.insert(Structure_BBDD.TABLE5, null, values12);

        ContentValues values13 = new ContentValues();
        values13.put(Structure_BBDD.COLUMNE2, "Cowpea Forage");
        values13.put(Structure_BBDD.COLUMNE3, "0.4");
        values13.put(Structure_BBDD.COLUMNE4, "0.1");
        values13.put(Structure_BBDD.COLUMNE5, "0.4");
        db.insert(Structure_BBDD.TABLE5, null, values13);
    }
