...
import com.example.apachepoi.hwpf.model.Colorref;
import com.example.apachepoi.hwpf.model.Hyphenation;
import com.example.apachepoi.hwpf.model.StyleSheet;
...
public final class CharacterSprmUncompressor extends SprmUncompressor
{
    ...
    public CharacterSprmUncompressor()
  {
    ...
    {
        org.apache.poi.hwpf.sprm.SprmIterator sprmIt = new org.apache.poi.hwpf.sprm.SprmIterator( grpprl, offset );
