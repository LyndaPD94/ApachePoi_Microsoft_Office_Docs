...
import com.example.apachepoi.hwpf.model.TabDescriptor;
import com.example.apachepoi.hwpf.model.types.TBDAbstractType;
import com.example.apachepoi.hwpf.usermodel.BorderCode;
import com.example.apachepoi.hwpf.usermodel.DateAndTime;
import com.example.apachepoi.hwpf.usermodel.DropCapSpecifier;
import com.example.apachepoi.hwpf.usermodel.LineSpacingDescriptor;
import com.example.apachepoi.hwpf.usermodel.ParagraphProperties;
import com.example.apachepoi.hwpf.usermodel.ShadingDescriptor;
import com.example.apachepoi.hwpf.usermodel.ShadingDescriptor80;
...
public final class ParagraphSprmUncompressor extends SprmUncompressor {
                                                  ...
                                                  int offset)
  {
    ...
    org.apache.poi.hwpf.sprm.SprmIterator sprmIt = new SprmIterator(grpprl, offset);

    while (sprmIt.hasNext())
    {
      org.apache.poi.hwpf.sprm.SprmOperation sprm = sprmIt.next();

      // PAPXs can contain table sprms if the paragraph marks the end of a
      // table row
      if (sprm.getType() == org.apache.poi.hwpf.sprm.SprmOperation.TYPE_PAP)
      {
          try
          {
   ...
   */
  static void unCompressPAPOperation (ParagraphProperties newPAP, org.apache.poi.hwpf.sprm.SprmOperation sprm)
  {
